      ...
      <ul class="date_select">
        ...
        <li class="view_status">
          ...
          <div class="form-check">
            <input class="form-check-input" type="radio" aria-label="공개" name="status" id="0" checked value=0>
          ...
          <div class="form-check">
            <input class="form-check-input" type="radio" aria-label="일부공개(예약)" name="status" id="1" value=1>
            <label class="form-check-label" for="status">
              일부공개
            </label>
          </div>
          ...
          <div class="form-check">
            <input class="form-check-input" type="radio" aria-label="비공개" name="status" id="2" value=2>
            <label class="form-check-label" for="status">
              비공개
            </label>
          </div>
