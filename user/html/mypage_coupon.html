...
<main class="usergrid">
  <div class="mypage_wrap df">
    <div class="mypage_common">
      <h2 class="h4">츄츄님 반갑습니다.</h2>
      <span class="body3">srimm3399@naver.com</span>
      <nav class="mypage_menu">
        <ul class="menu df fdc">
          <li><a href="" class="line_btn">내 강의실</a></li>
          <li><a href="" class="line_btn">내 쿠폰함</a></li>
          <li><a href="" class="line_btn">수강 후기</a></li>
          <li><a href="" class="line_btn">1:1 질문</a></li>
          <li><a href="" class="secondary_btn">회원탈퇴</a></li>
          <li><a href="" class="primary_btn">로그아웃</a></li>
        </ul>
      </nav>
    </div>
    <div class="my_coupon">
